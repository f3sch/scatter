...
BENCHMARK(benchSerialBinningFullyAssociativeId)->Apply(pad::benchmarks::benchArgs)->UseRealTime();
...
BENCHMARK(benchSerialBinningFullyAssociativeRandom)->Apply(pad::benchmarks::benchArgs)->UseRealTime();
...
BENCHMARK(benchSerialBinningDirectMappingId)->Apply(pad::benchmarks::benchArgs)->UseRealTime();
...
BENCHMARK(benchSerialBinningDirectMappingRandom)->Apply(pad::benchmarks::benchArgs)->UseRealTime();
